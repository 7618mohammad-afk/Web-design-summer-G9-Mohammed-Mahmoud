function Click(element) {
    var itemslist = document.getElementsByClassName('js-blue')

    for (let i = 0; i < itemslist.length; i++) {
        itemslist[i].style.color = "black"
    }
...
function showUser() {
    ...
    h4Name.innerText =  users[index].name
    h4Email.innerText = users[index].email
